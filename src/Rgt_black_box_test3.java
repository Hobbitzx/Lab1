...
class Rgt_black_box_test3 {

	@Test
	void testCalcShortestPathStringStringGraph() {
        Graph spGraph3 = new Graph();
        GraphProcess gp3 = new GraphProcess();
		...
		spGraph3.ghashmap.put(s1[0], V);
		for(int i=0;i<s1.length-1;i++)
		{
			spGraph3.put(s1[i], s1[i+1]);    
		}
		String Actual = gp3.calcShortestPath("civilizations","new",spGraph3);
