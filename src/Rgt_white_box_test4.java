...
class Rgt_white_box_test4 {

	@Test
	void testQueryBridgeWords() {
        Graph spGraph8 = new Graph();
        GraphProcess gp8 = new GraphProcess();
		...
		spGraph8.ghashmap.put(s1[0], V);
		for(int i=0;i<s1.length-1;i++)
		{
			spGraph8.put(s1[i], s1[i+1]);    
		}
		String Actual = gp8.queryBridgeWords("seek","out",spGraph8);
