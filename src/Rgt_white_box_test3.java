...
class Rgt_white_box_test3 {

	@Test
	void testQueryBridgeWords() {
        Graph spGraph7 = new Graph();
        GraphProcess gp7 = new GraphProcess();
		...
		spGraph7.ghashmap.put(s1[0], V);
		for(int i=0;i<s1.length-1;i++)
		{
			spGraph7.put(s1[i], s1[i+1]);    
		}
		String Actual = gp7.queryBridgeWords("zx","cyk",spGraph7);
